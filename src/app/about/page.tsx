      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 20px 80px' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '28px 24px', marginBottom: 32 }}>
          ...
          <p style={{ fontFamily: 'var(--font-serif,serif)', fontSize: 22, lineHeight: 1.5, fontStyle: 'italic' }}>
            &ldquo;To make world-class financial planning accessible to every person on earth &mdash; not just those who can afford a financial advisor.&rdquo;
          </p>
        </div>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', fontSize: 13 }}>
          <Link href="/signup" style={{ display: 'inline-flex', padding: '12px 24px', background: 'var(--accent)', color: '#09090b', borderRadius: 8, fontWeight: 600, textDecoration: 'none' }}>Build my free plan &rarr;</Link>
