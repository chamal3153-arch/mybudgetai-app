      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 20px 80px' }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 15, lineHeight: 1.7 }}>
            These Terms of Service govern your use of MyBudget.AI, a product of <a href="https://costsaverai.com" target="_blank" rel="noreferrer" style={{ color: 'var(--accent)', textDecoration: 'none' }}>CostSaver AI</a>. By using our service, you agree to these terms.
          </p>
        </div>
