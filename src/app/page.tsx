    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg)', overflow: 'hidden' }}>
      ...
      <section style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '80px 20px 60px', minHeight: '90vh' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 600, width: '100%' }}>
          ...
          <a href="https://costsaverai.com" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, color: 'var(--muted)', textDecoration: 'none', border: '1px solid var(--border)', padding: '4px 12px', borderRadius: 100, marginBottom: 40, background: 'var(--surface)' }}>
            A <strong style={{ color: 'var(--body)' }}>CostSaver AI</strong> product â†—
          </a>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, marginBottom: 36, flexWrap: 'wrap' }}>
            <span style={{ fontSize: 13, color: 'var(--muted)' }}><span style={{ color: '#f0c060' }}>â˜…â˜…â˜…â˜…â˜…</span> 4.9 / 5</span>
            <span style={{ fontSize: 13, color: 'var(--muted)' }}>ðŸ‘¤ 12,000+ plans generated</span>
            <span style={{ fontSize: 13, color: 'var(--muted)' }}>ðŸŒ 195 countries</span>
          </div>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.7, color: 'var(--muted)', maxWidth: 440, margin: '0 auto 40px' }}>
            Answer 8 questions. Get a personalized budget, investment picks, and a 90-day action plan â€” powered by AI.
          </p>
          ...
          <p style={{ marginTop: 14, fontSize: 13, color: 'var(--muted)' }}>Free to start Â· <strong style={{ color: 'var(--body)' }}>Full report $5</strong> Â· No credit card needed</p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 18, flexWrap: 'wrap', marginTop: 40, paddingTop: 28, borderTop: '1px solid var(--border)', fontSize: 13, color: 'var(--muted)' }}>
            {['ðŸ“Š Budget breakdown','ðŸ“ˆ Investment picks','ðŸ¦ Savings accounts','ðŸ“… 90-day action plan','ðŸ—“ï¸ Goal timeline','ðŸ“„ PDF export'].map(f => <span key={f}>{f}</span>)}
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '60px 20px', borderTop: '1px solid var(--border)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20 }}>
            {[
              { step: '01', icon: 'âœï¸', title: 'Answer 8 questions', desc: 'Tell us your income, expenses, goal and country. Takes 60 seconds.' },
              { step: '02', icon: 'ðŸ¤–', title: 'AI builds your plan', desc: 'Our AI analyzes your situation and generates a personalised financial plan.' },
              { step: '03', icon: 'ðŸ“Š', title: 'Take action', desc: 'Get your budget, investment picks, and a 90-day action plan you can track.' },
            ].map(s => (
      ...
      <section style={{ padding: '60px 20px', borderTop: '1px solid var(--border)', background: 'var(--surface)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
            {[
              { name: 'Sarah M.', country: 'ðŸ‡ºðŸ‡¸ United States', rating: 5, text: 'I finally understand where my money goes. The 90-day plan is incredibly specific â€” it tells you exactly what to do each month. Worth every cent.' },
              { name: 'James K.', country: 'ðŸ‡¬ðŸ‡§ United Kingdom', rating: 5, text: 'The investment picks for UK specifically were spot on. I had no idea about ISAs until this plan. Already opened one.' },
              { name: 'Priya R.', country: 'ðŸ‡®ðŸ‡³ India', rating: 5, text: 'Most budget tools are made for Americans. This one actually knows about Indian markets, SIPs, and PPF. Brilliant.' },
              { name: 'Carlos B.', country: 'ðŸ‡§ðŸ‡· Brazil', rating: 5, text: 'The brutal honest insight hit me hard but it was exactly what I needed to hear. Completely changed how I think about money.' },
              { name: 'Amira T.', country: 'ðŸ‡¿ðŸ‡¦ South Africa', rating: 5, text: 'The business ideas section was unexpected and amazing. I actually started the freelance idea it suggested. R8k in first month.' },
              { name: 'David L.', country: 'ðŸ‡¨ðŸ‡¦ Canada', rating: 5, text: '$5 for this level of personalisation is almost criminal. I paid a financial advisor $200/hr for less useful advice.' },
            ].map(t => (
              <div key={t.name} style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 14, padding: '22px 20px' }}>
                ...
                <p style={{ fontSize: 14, lineHeight: 1.7, color: 'var(--body)', marginBottom: 16 }}>"{t.text}"</p>
                <div>
      ...
      <section style={{ padding: '60px 20px', borderTop: '1px solid var(--border)', textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 15, marginBottom: 28 }}>Compound interest, savings goal, mortgage, and budget split calculators â€” no signup required.</p>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 32, marginBottom: 36 }}>
            ...
            <div>
              ...
              <a href="https://costsaverai.com" target="_blank" rel="noreferrer" style={{ fontSize: 13, color: 'var(--accent)', textDecoration: 'none' }}>costsaverai.com â†—</a>
            </div>
          </div>
          <div style={{ borderTop: '1px solid var(--border)', paddingTop: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10 }}>
            <span style={{ fontSize: 12, color: 'var(--muted)' }}>Â© 2026 CostSaver AI. All rights reserved.</span>
            <span style={{ fontSize: 12, color: 'var(--muted)' }}>AI-generated plans Â· Not financial advice Â· Always consult a qualified advisor</span>
          </div>
        </div>
      </footer>
    </main>
